...
public class MatcherFactory {
    ...
    public static class Matcher<T> {
        ...
        public ResultMatcher contentJson(T expected) {
            return result -> assertMatch(ru.javaops.cloudjava.util.JsonUtil.readValue(getContent(result), clazz), expected);
        }
        ...
        public ResultMatcher contentJson(Iterable<T> expected) {
            return result -> assertMatch(ru.javaops.cloudjava.util.JsonUtil.readValues(getContent(result), clazz), expected);
        }

        public T readFromJson(ResultActions action) throws UnsupportedEncodingException {
            return ru.javaops.cloudjava.util.JsonUtil.readValue(getContent(action.andReturn()), clazz);
        }
